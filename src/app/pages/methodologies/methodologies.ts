...
const METHODOLOGIES: Methodology[] = [
  {
    ...
    type: 'PROCESO',
    summary: 'Metodología de proceso del equipo. Define CÓMO se desarrolla cada feature: de idea a código verificado en 7 fases con aprobación entre cada una. Es el default para todo /spec.',
    philosophy: [
